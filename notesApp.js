...
function showDeletedNotes() {
  ...
  // Otherwise, parse the deleted notes as JSON and proceed to loop through them
  else {
    deletedNotes = JSON.parse(deletedNotes);
  }
...
function archiveNote(ind) {
  ...
  // Otherwise, parse the notes as JSON and proceed to archive the note at the given index
  else {
    notes = JSON.parse(notes);
  }
  ...
  // Otherwise, parse the archived notes as JSON
  else {
...
function showArchivedNotes() {
  ...
  // Otherwise, parse the archived notes as JSON and proceed to display them
  else {
    archivedNotes = JSON.parse(archivedNotes);
  }
